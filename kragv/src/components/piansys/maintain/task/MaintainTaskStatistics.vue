      ...
      <el-col :span="6">
        <el-card class="parampanel"
          ...
          <div class="panelcontent">
            ...
            <div class="panelfont">
              <div class="panelfontnum">{{receiveData.missionCompletionRateBlock.missionCreatCount}}</div>
      ...
      <el-col :span="6">
        <el-card class="parampanel"
          ...
          <div class="panelcontent">
            ...
            <div class="panelfont">
              <div class="panelfontnum">{{receiveData.missionCompletionRateBlock.missionCompletedCount}}</div>
              <div class="panelfontstatus">任务完成数</div>
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :span="6">
        <el-card class="parampanel"
          ...
          <div class="panelcontent">
            ...
            <div class="panelfont">
              <div class="panelfontnum">{{receiveData.missionCompletionRateBlock.missionCompletionRate}}</div>
              <div class="panelfontstatus">任务达成率</div>
            </div>
          </div>
        </el-card>
      </el-col>
          ...
          <div class="panelcontent">
            ...
            <div class="panelfont">
              <div class="panelfontnum"
                   id="timecard">{{receiveData.missionCompletionRateBlock.calTimestamp | dateFormat_date}}</div>
              <div class="panelfontnum"
                   id="timecard">{{receiveData.missionCompletionRateBlock.calTimestamp | dateFormat_time}}</div>
              <div class="panelfontstatus">周期开始时间</div>
            </div>
          </div>
        </el-card>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    async getStatisticsList () {
      const { data: res } = await this.$http.get('maintain/missionstatistics', { params: this.queryInfo })
      if (res.meta.status !== 200) {
